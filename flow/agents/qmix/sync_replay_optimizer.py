...
import ray
from flow.agents.qmix.prioritized_replay_buffer import ReplayBuffer, \
...
class SyncReplayOptimizer(PolicyOptimizer):
    ...
    def __init__(self,
        ...
        if prioritized_replay:
            ...
            def new_buffer():
                print('got prioritized replay bruh')
        ...
        with self.grad_timer:
            ...
            for policy_id, info in info_dict.items():
                ...
                if isinstance(replay_buffer, PrioritizedReplayBuffer):
                    td_error = info["td_error"].detach().numpy()
                    new_priorities = (
    ...
    def _replay(self):
        ...
        with self.replay_timer:
            for policy_id, replay_buffer in self.replay_buffers.items():
                ...
                if isinstance(replay_buffer, PrioritizedReplayBuffer):
                    (obses_t, actions, rewards, obses_tp1, dones, infos, eps_ids, unroll_ids,
                     agent_indices, weights,
                    ...
                    (obses_t, actions, rewards, obses_tp1,
                     dones, infos, eps_ids, unroll_ids, agent_indices) = replay_buffer.sample_with_idxes(idxes)
