...
#
#ray exec ray_autoscale.yaml \
#"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py l800_h3000_td3senv_ncrit12_av0p2 --num_iters 300 --checkpoint_freq 50 --av_frac 0.2 \
#--num_samples 1 --horizon 2000 --low_inflow 800 --high_inflow 3000 --simple_env \
#--sim_step 0.5 --create_inflow_graph --sims_per_step 1 --rew_n_crit 12 \
#--td3 --grid_search --use_s3" \
#--start --stop --cluster-name ev_0pen_2 --tmux
#
#ray exec ray_autoscale.yaml \
#"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py l800_h3000_td3senv_ncrit12_av0p4 --num_iters 500 --checkpoint_freq 50 --av_frac 0.4 \
#--num_samples 1 --horizon 2000 --low_inflow 800 --high_inflow 3000 --simple_env \
#--sim_step 0.5 --create_inflow_graph --sims_per_step 1 --rew_n_crit 12 \
#--td3 --grid_search --use_s3" \
#--start --stop --cluster-name ev_0pen_3 --tmux
#
#ray exec ray_autoscale.yaml \
#"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py l800_h3000_td3senv_ncrit12_av1p0 --num_iters 500 --checkpoint_freq 50 --av_frac 1.0 \
#--num_samples 1 --horizon 2000 --low_inflow 800 --high_inflow 3000 --simple_env \
#--sim_step 0.5 --create_inflow_graph --sims_per_step 1 --rew_n_crit 12 \
#--td3 --grid_search --use_s3" \
#--start --stop --cluster-name ev_0pen_4 --tmux
...
ray exec ray_autoscale.yaml \
"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py l800_h3000_td3senv_outrew_av0p1 --num_iters 300 --checkpoint_freq 50 --av_frac 0.1 \
--num_samples 1 --horizon 2000 --low_inflow 800 --high_inflow 3000 --simple_env \
--sim_step 0.5 --create_inflow_graph --sims_per_step 1 --life_penalty 0.0 \
--td3 --grid_search --use_s3" \
--start --stop --cluster-name ev_0pen5 --tmux

ray exec ray_autoscale.yaml \
"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py l800_h3000_td3senv_outrew_av0p2 --num_iters 300 --checkpoint_freq 50 --av_frac 0.2 \
--num_samples 1 --horizon 2000 --low_inflow 800 --high_inflow 3000 --simple_env \
--sim_step 0.5 --create_inflow_graph --sims_per_step 1 --life_penalty 0.0 \
--td3 --grid_search --use_s3" \
--start --stop --cluster-name ev_0pen_6 --tmux
...
ray exec ray_autoscale.yaml \
"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py l800_h3000_td3senv_outrew_av0p4 --num_iters 500 --checkpoint_freq 50 --av_frac 0.4 \
--num_samples 1 --horizon 2000 --low_inflow 800 --high_inflow 3000 --simple_env \
--sim_step 0.5 --create_inflow_graph --sims_per_step 1 --life_penalty 0.0 \
--td3 --grid_search --use_s3" \
--start --stop --cluster-name ev_0pen_7 --tmux
...
ray exec ray_autoscale.yaml \
"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py l800_h3000_td3senv_outrew_av1p0 --num_iters 500 --checkpoint_freq 50 --av_frac 1.0 \
--num_samples 1 --horizon 2000 --low_inflow 800 --high_inflow 3000 --simple_env \
--sim_step 0.5 --create_inflow_graph --sims_per_step 1 --life_penalty 0.0 \
--td3 --grid_search --use_s3" \
--start --stop --cluster-name ev_0pen_8 --tmux