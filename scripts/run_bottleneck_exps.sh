...
# Imitation
ray exec ray_autoscale.yaml \
"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py 3pen_im_i1900 --num_iters 500 --checkpoint_freq 50 --av_frac 0.4 \
--num_samples 1 --grid_search --n_cpus 6 --use_s3 --rollout_scale_factor 1.0 --horizon 400 --low_inflow 1900 --high_inflow 1900 --aggregate_info \
--imitate --multi_node --sim_step 0.5" \
--start --stop --cluster-name kp_3pen_im1 --tmux

# Imitation with CVF
ray exec ray_autoscale.yaml \
"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py 3pen_im_cvf_i1900 --num_iters 500 --checkpoint_freq 50 --av_frac 0.4 \
--num_samples 1 --grid_search --n_cpus 6 --use_s3 --rollout_scale_factor 1.0 --horizon 400 --low_inflow 1900 --high_inflow 1900 --aggregate_info \
...
ray exec ray_autoscale.yaml \
"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py 3pen_im_i1900_f0p1 --num_iters 500 --checkpoint_freq 50 --av_frac 0.4 \
--num_samples 1 --grid_search --n_cpus 6 --use_s3 --rollout_scale_factor 1.0 --horizon 400 --low_inflow 1900 --high_inflow 1900 --aggregate_info \
...
ray exec ray_autoscale.yaml \
"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py 3pen_im_cvf_i1900_f0p1 --num_iters 500 --checkpoint_freq 50 --av_frac 0.4 \
--num_samples 1 --grid_search --n_cpus 6 --use_s3 --rollout_scale_factor 1.0 --horizon 400 --low_inflow 1900 --high_inflow 1900 --aggregate_info \
...
# Just CVF
ray exec ray_autoscale.yaml \
"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py 3pen_cvf_i1900 --num_iters 500 --checkpoint_freq 50 --av_frac 0.4 \
--num_samples 1 --grid_search --n_cpus 6 --use_s3 --rollout_scale_factor 1.0 --horizon 400 --low_inflow 1900 --high_inflow 1900 --aggregate_info \
