...
ray exec ray_autoscale.yaml "python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py MultiDecentralObsBottleneck\
 --num_cpus 14 --use_s3 \
--grid_search --multi_node --rollout_scale_factor 2 --num_samples 2" \
...
ray exec ray_autoscale.yaml "python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py MultiCentralObsBottleneck\
 --num_cpus 14 --use_s3 \
--grid_search --multi_node --central_obs --rollout_scale_factor 2 --num_samples 2" \
--start --stop --cluster-name=ev_test2 --tmux

ray exec ray_autoscale.yaml "python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py MultiDecentralObsBottleneck\
 --num_cpus 14 --use_s3 \
--grid_search --multi_node --rollout_scale_factor 2 --num_samples 2 --low_inflow 2400 --high_inflow 2400" \
--start --stop --cluster-name=ev_test3 --tmux

ray exec ray_autoscale.yaml "python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py MultiCentralObsBottleneck\
 --num_cpus 14 --use_s3 \
--grid_search --multi_node --central_obs --rollout_scale_factor 2 --num_samples 2 --low_inflow 2400 --high_inflow 2400" \
