...
"python flow/examples/rllib/multiagent_exps/multiagent_bottleneck.py MA_NLC_NCM_NLSTM_NAG_NCN --num_iters 350 --checkpoint_freq 1 \
    --num_samples 2 --grid_search --n_cpus 30 --multi_node --use_s3 --rollout_scale_factor 1.0 --horizon 2000" \
...
#    --num_samples 2 --grid_search --n_cpus 30 --multi_node --use_lstm --use_s3 --rollout_scale_factor 1.0 --horizon 2000" \
...
#    --num_samples 2 --grid_search --n_cpus 30 --multi_node --use_s3 --aggregate_info --rollout_scale_factor 1.0 --horizon 2000" \
...
#    --num_samples 2 --grid_search --n_cpus 30 --multi_node --use_lstm --use_s3 --aggregate_info --rollout_scale_factor 1.0 --horizon 2000" \
...
#    --num_samples 2 --grid_search --n_cpus 30 --multi_node --use_s3 --communicate --rollout_scale_factor 1.0 --horizon 2000" \
...
#    --num_samples 2 --grid_search --n_cpus 30 --multi_node --use_lstm --use_s3 --communicate --rollout_scale_factor 1.0 --horizon 2000" \
...
#    --num_samples 2 --grid_search --n_cpus 30 --multi_node --use_s3 --aggregate_info --communicate --rollout_scale_factor 1.0 --horizon 2000" \
...
#    --num_samples 2 --grid_search --n_cpus 30 --multi_node --use_lstm --use_s3 --aggregate_info --communicate --rollout_scale_factor 1.0 --horizon 2000" \
